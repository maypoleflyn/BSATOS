#!/usr/bin/perl
  ...
  foreach my $index(@key){
       ...
       system("mkdir $dir;perl /home/shen/project/work/big_project/qtlseq/tools/get.bed.pl sum_all $hash{$index}->[0] $hash{$index}->[1] $hash{$index}->[2] $index > $out1;perl /home/shen/project/work/big_project/qtlseq/tools/get.bed.pl  /home/shen/project/work/big_project/project3/new/G_vs_J_genome_variations/G_vs_H.vcf_out.apple_multianno.txt $hash{$index}->[0] $hash{$index}->[1] $hash{$index}->[2] $index > $out2");
     ...
     system("perl /home/shen/project/work/big_project/qtlseq/tools/get.bed.pl /home/shen/project/work/big_project/project3/new/G_vs_J_genome_variations/SV/sv.filtered $hash{$index}->[0] $hash{$index}->[1] $hash{$index}->[2] $index > $out10");  
      ...
      if($index=~/H/){
                 system("perl /home/shen/project/work/big_project/qtlseq/tools/filter_H.pl $out6 > $out8"); 
                 system("perl /home/shen/project/work/big_project/qtlseq/tools/filter_H.pl $out10 > $out9");
                  }
        if($index=~/G/){
                 system("perl /home/shen/project/work/big_project/qtlseq/tools/filter_G.pl $out6 > $out8");
                
                 system("perl /home/shen/project/work/big_project/qtlseq/tools/filter_G.pl $out10 > $out9");

     
                  }
if($index=~/J/){
                 system("perl /home/shen/project/work/big_project/qtlseq/tools/filter_J.pl $out6 > $out8"); 

              system("perl /home/shen/project/work/big_project/qtlseq/tools/filter_J.pl $out10 > $out9");
