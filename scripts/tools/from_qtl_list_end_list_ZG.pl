#!/usr/bin/perl
  ...
  foreach my $index(@key){
     ...
     system("perl /home/shen/project/work/big_project/qtlseq/tools/get.bed.pl /home/shen/project/work/big_project/project3/new/G_vs_J_genome_variations/SV/sv.filtered $hash{$index}->[0] $hash{$index}->[1] $hash{$index}->[2] $index > $out10");  
      ...
      if($index=~/H/){
                 system("perl /home/shen/project/work/big_project/qtlseq/tools/filter_zg_h.pl $out6 > $out8"); 
                 system("perl /home/shen/project/work/big_project/qtlseq/tools/filter_zg_h.pl $out10 > $out9");
                  }
        if($index=~/Z/){
                 system("perl /home/shen/project/work/big_project/qtlseq/tools/filter_zg_z.pl $out6 > $out8");
                
                 system("perl /home/shen/project/work/big_project/qtlseq/tools/filter_zg_z.pl $out10 > $out9");

     
                  }
if($index=~/G/){
                 system("perl /home/shen/project/work/big_project/qtlseq/tools/filter_zg_g.pl $out6 > $out8"); 

              system("perl /home/shen/project/work/big_project/qtlseq/tools/filter_zg_g.pl $out10 > $out9");
