...
=cut
 ...
 die `pod2text $0` if ( @ARGV==0 || $h);
   ...
   while(<LOP>){
      ...
      my $sf1=$b1{$b[21]}{"T"}+$b1{$b[21]}{"F"};
      my $sf2=$k1{$b[24]}{"T"}+$k1{$b[24]}{"F"};
      my $sf3=$b2{$b[21]}{"T"}+$b2{$b[21]}{"F"};
      my $sf4=$k2{$b[24]}{"T"}+$k2{$b[24]}{"F"};
      my $sf5=$b3{$b[21]}{"T"}+$b3{$b[21]}{"F"};
      my $sf6=$k3{$b[24]}{"T"}+$k3{$b[24]}{"F"};
      my $sf7=$b4{$b[21]}{"T"}+$b4{$b[21]}{"F"};
      my $sf8=$k4{$b[24]}{"T"}+$k4{$b[24]}{"F"};
...
print "#CHROM\tPOS\tREF\tALT\tP_HAP1\tP_HAP2\tP_NAME\tP_EN\tP_G\tM_HAP1\tM_HAP2\tM_NAME\tM_EN\tM_G\n";
