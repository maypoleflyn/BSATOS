...
Outputs:
     ...
     *_g3.res.ad_afd  [FILE]  smoothed curve with different window in each chromosome based on polished read counts of G3 type loci
     ...
     g1.igv        [FILE] g1 IGV format file for Integrative Genomics Viewer    
     g2.igv        [FILE] g2 IGV format file for Integrative Genomics Viewer
     g3.igv        [FILE] g3 IGV format file for Integrative Genomics Viewer
