...
########################################################
           ...
           print STDOUT "calculate G1 allele frequency difference between two extreme pools\n";
           print $lo "calculate G1 allele frequency difference between two extreme pools\t$cdn1\n";
...
###########################################################
           ...
           $idx++;
           my $cdn2 = "CMD".$idx.":";
           print STDOUT "calculate G2 allele frequency difference between two extreme pools\n";
           print $lo "calculate G2 allele frequency difference between two extreme pools\t$cdn2\n";
...
############################################################
           ...
           $idx++;
           my $cdn3 = "CMD".$idx.":"; 
           print STDOUT "calculate G3 allele frequency difference between two extreme pools\n";
           print $lo "calculate G3 allele frequency difference between two extreme pools\t$cdn3\n";
...
###########################################
           ...
           my $mx4=$hlog{$cdn4};
           my $m1c= "cat $work_dir/\*$gn1\_afd >>$sum1";
...
####################################################
           ...
           my $mx5=$hlog{$cdn5};
           my $m2c= "cat $work_dir/\*$gn2\_afd >>$sum2";
...
###############################################
           ...
           my $mx6=$hlog{$cdn6};
           my $m3c= "cat $work_dir/\*$gn3\_afd >>$sum3";
...
#################################################
           ...
           my $mx7=$hlog{$cdn7};
           my $adc1 = "$filter -k cn -A A -B E $sum1 $phase > $ad1";
...
####################################################
           ...
           my $mx8=$hlog{$cdn8};
           my $adc2 ="$filter -k cn -A A -B E $sum2 $phase > $ad2";
...
##################################################
           ...
           my $mx9=$hlog{$cdn9};
           my $adc3 = "$filter -k cn -A A -B E $sum3 $phase > $ad3";
