...
sub runscript {
	...
	die "$G_USAGE" if ($help || !defined($genome));
      ...
      #    open (my $ofh, ">$script") or die $!;
        ...
        print  "$bsatos prepar  --Pp1 $pf1  --Pp2 $pf2 --Mp1 $mf1 --Mp2 $mf2 --genome $genome --gtf $gtf  --oprefix prepar\n"  
                                                                             }else{
        print  "$bsatos prepar --Pbam $pb --Mbam $mb --genome $genome  --oprefix prepar --gtf $gtf\n"; 
                                                                                  } 
        if(defined($hf1) && defined($hf2) && defined($lf1) && defined($lf2)){           
        print  "$bsatos prep --Hp1 $hf1 --Hp2 $hf2 --Lp1 $lf1  --Lp2 $lf2 --genome $genome --g1 prepar_dir/P_M_G1 --g2 prepar_dir/P_M_G2 --g3 prepar_dir/P_M_G3  --oprefix prep\n";  
                                                                            }else{ 
        print  "$bsatos prep  --Hbam $hb --Lbam $lb --genome $genome   --g1 prepar_dir/P_M_G1 --g2 prepar_dir/P_M_G2 --g3 prepar_dir/P_M_G3  --oprefix prep\n";                                                                      
        ...
        print "$bsatos haplotype --Pbam $pb --Mbam $mb --Hbam $hb --Lbam $lb  --genome $genome  --oprefix haplotype --var prepar_dir/M_P.snp\n";     
        print "$bsatos afd  --oprefix afd  -g1 prep_dir/g1.res  -g2 prep_dir/g2.res  -g3 prep_dir/g3.res  -phase haplotype_dir/merged.block\n";
        print "$bsatos polish  --oprefix polish  -g1 afd_dir/g1.res.ad -g2 afd_dir/g2.res.ad -g3  afd_dir/g3.res.ad -phase  haplotype_dir/merged.block\n";  
        print "$bsatos qtl_pick  --oprefix qtl_pick -g1 polish_dir/g1.res.ad.ad -g2 polish_dir/g2.res.ad.ad  -g3 polish_dir/g3.res.ad.ad --v prepar_dir/anno/snv.AT_multianno.txt --sv prepar_dir/anno/sv.AT_multianno.txt -gtf $gtf --hap haplotype_dir/merged.block\n"; 
