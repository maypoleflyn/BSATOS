    ...
    unless(defined($outputPrefix)){
     ...
     unless(defined($pr)){
      ...
      #    open (my $ofh, ">$script") or die $!;
        ...
        print "$bsatos haplotype --phase2 $phase2 --dep $dep --aq3 $aq3 --vq3 $vq3  --pb $pb --mb $mb --hb $hb --lb $lb  --r $genome  --o haplotype --var prepar_dir/M_P.snv\n";
     
        print "$bsatos afd --sd $sd --w $w --th $th --m $m --o  afd  --g1 prep_dir/g1.res  --g2 prep_dir/g2.res  --g3 prep_dir/g3.res --h haplotype_dir/haplotype.block\n";

        print "$bsatos polish --sd $sd --w $w --th $th --m $m --o polish --gs1 afd_dir/g1.res.ad --gs2 afd_dir/g2.res.ad --gs3 afd_dir/g3.res.ad -h haplotype_dir/haplotype.block\n";
  
        print "$bsatos qtl_pick --q $q --pr $pr --o qtl_pick --gp1 polish_dir/g1.res.ad.ad --gp2 polish_dir/g2.res.ad.ad --gp3 polish_dir/g3.res.ad.ad --v prepar_dir/anno/snv.AT_multianno.txt --sv prepar_dir/anno/sv.AT_multianno.txt -gtf $gtf --h haplotype_dir/haplotype.block\n"; 
