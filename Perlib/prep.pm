...
################################################################################
         ...
         print STDOUT "G1 loci genotyping in High pool\n";
         print $lo "G1 loci genotyping in High pool\nCMD12:\t";   
...
################################################################################
         ...
         print STDOUT "G2 loci genotyping in High pool\n";
         print $lo "G2 loci genotyping in High pool\nCMD13:\t"; 
...
###############################################################################
         ...
         print STDOUT "G3 loci genotyping in High pool\n";
         print $lo "G3 loci genotyping in High pool\nCMD14:\t"; 
...
##############################################################################
         ...
         print STDOUT "G1 loci genotyping in Low pool\n";
         print $lo "G1 loci genotyping in Low pool\nCMD15:\t";
...
#########################################################################
         ...
         print STDOUT "G2 loci genotyping in Low pool\n";
         print $lo "G2 loci genotyping in Low pool\nCMD16:\t";
...
###########################################
         ...
         print STDOUT "filter and get G1 loci reads count data in H pool\n";
         print $lo "filter and get G1 loci reads count data in H pool\nCMD24:\t";
...
###############################################
         ...
         print STDOUT "filter and get G2 loci reads count data in H pool\n";  
         print $lo "filter and get G2 loci reads count data in H pool\nCMD25:\t";    
...
############################################
         ...
         print STDOUT "filter and get G3 loci reads count data in H pool\n";         
         print $lo "filter and get G3 loci reads count data in H pool\nCMD26:\t";
...
#############################################
         ...
         print STDOUT "filter and get G1 loci reads count data in L pool\n";
         print $lo "filter and get G1 loci reads count data in L pool\nCMD27:\t";
...
####################################################
         ...
         print STDOUT "filter and get G2 loci reads count data in L pool\n";
         print $lo "filter and get G2 loci reads count data in L pool\nCMD28:\t";
...
##########################################
         ...
         print STDOUT "filter and get G3 loci reads count data in L pool\n";         
         print $lo "filter and get G3 loci reads count data in L pool\nCMD29:\t";
...
#########################################
         ...
         print STDOUT "obtain G1 loci reads count data\n";
         print $lo "obtain G1 loci reads count data\nCMD30:\t";
...
############################################
         ...
         print STDOUT "obtain G2 loci reads count data\n";
         print $lo "obtain G2 loci reads count data\nCMD31\t";
